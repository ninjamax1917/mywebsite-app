<nav class="desktop-nav font-open-sans font-medium hidden lg:flex lg:absolute lg:left-1/2 lg:transform lg:-translate-x-1/2 space-x-10"
    ...
    {{-- Убираем пункт "Главная", т.к. занимает много места --}}
    {{-- <a href="#" class="underline-anim-nav text-gray-800 transition-colors inline-flex items-center gap-2 group"
        role="menuitem">Главная</a> --}}

    <a id="services-link" href="#"
        class="underline-anim-nav text-gray-800 transition-colors inline-flex items-center gap-2 group whitespace-nowrap"
    ...
    <!-- services dropdown (горизонтально) -->
