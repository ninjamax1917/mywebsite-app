<div class="bg-[#232323] text-gray-300">
    <div class="max-w-7xl mx-auto px-6 py-4 md:py-12">
            ...
            <div class="col-span-2 md:col-span-1">
                <div class="flex flex-col md:block">
                    <div class="flex-shrink-0">
                        <!-- Логотип / название -->
                        <span class="text-white font-bold text-2xl">VARIVODA</span>
                    </div>

                    <p class="mt-3 md:mt-2 text-sm text-gray-400 max-w-sm">
                        Современные решения в энергетике, сетях связи и безопасности.
                    </p>
                </div>
            </div>

            <!-- Компания (колонка 1, строка 2) -->
            <div class="col-span-1">
                <h3 class="text-sm font-open-sans font-semibold text-gray-200 mb-3">Компания</h3>
                <ul class="space-y-2 text-sm text-gray-400">
                    <li><a href="#" class="underline-anim hover:text-white transition-colors">О нас</a></li>
                    <li><a href="#" class="underline-anim hover:text-white transition-colors">Кейсы</a></li>
                    <li><a href="#" class="underline-anim hover:text-white transition-colors">Контакты</a></li>
                </ul>
            </div>

            <!-- Услуги (колонка 2, строка 2) -->
            <div class="col-span-1">
                <h3 class="text-sm font-open-sans font-semibold text-gray-200 mb-3">Услуги</h3>
                <ul class="space-y-2 text-sm text-gray-400">
                    <li><a href="#" class="underline-anim hover:text-white transition-colors">Видеонаблюдение</a>
                    </li>
                    <li><a href="#" class="underline-anim hover:text-white transition-colors">Сетевые решения</a>
                    </li>
                    <li><a href="#" class="underline-anim hover:text-white transition-colors">Безопасность</a>
                    </li>
                    <li><a href="#" class="underline-anim hover:text-white transition-colors">Электромонтаж</a>
                    </li>
                    <li><a href="#"
                            class="underline-anim hover:text-white transition-colors">Электролаборатория</a></li>
                </ul>
            </div>

            <!-- Контакты — по центру, занимает обе колонки; на md+ смещается влево -->
            <div class="col-span-2 flex flex-col items-center md:items-start">
                <div class="flex flex-col items-center md:items-start">
                    <h3 class="text-sm font-open-sans font-semibold text-gray-200 mb-3 text-center md:text-left">
                        Связаться</h3>
                    <div class="flex items-center gap-4 justify-center md:justify-start">
                        <a href="https://t.me/your-telegram" target="_blank" rel="noopener noreferrer"
                            class="p-2 rounded-full bg-transparent text-gray-300 hover:text-[#0077FF] transition-colors duration-200"
                            aria-label="Telegram">
                            <svg class="w-6 h-6" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 191 174"
                                fill="currentColor">
                                <path
                        ...
                        <a href="https://t.me/your-max" target="_blank" rel="noopener noreferrer"
                            class="p-2 rounded-full bg-transparent text-gray-300 hover:text-[#0077FF] transition-colors duration-200"
                            aria-label="Max">
                            <svg class="w-6 h-6" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 174.03 174"
                                fill="currentColor">
                                <path
                        ...
                        <a href="https://wa.me/your-number" target="_blank" rel="noopener noreferrer"
                            class="p-2 rounded-full bg-transparent text-gray-300 hover:text-[#0077FF] transition-colors duration-200"
                            aria-label="WhatsApp">
                            <svg class="w-6 h-6" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 174 174" role="img"
                                aria-hidden="true">
                    ...
                    <a href="mailto:info@example.com"
                        class="mt-4 text-sm text-gray-400 hover:text-white transition-colors text-center md:text-left">ip_varivoda@mail.ru</a>
                </div>
            </div>
        </div>

        <!-- нижняя полоса -->
        <div class="border-t border-gray-600 mt-4 pt-4 flex flex-col md:flex-row items-center justify-between gap-4">
            <p class="text-xs text-gray-500">&copy; {{ date('Y') }} VARIVODA. Все права защищены.</p>
            <div class="text-xs text-gray-500">&lt;/&gt; Разработка: ninjamax</div>
        </div>
    </div>
</div>
